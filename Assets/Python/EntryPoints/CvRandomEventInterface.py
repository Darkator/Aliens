...
def SpanisCvilWar(argsList):
	...
	player = gc.getPlayer(kTriggeredData.ePlayer)
	plot = gc.getMap().plot(44, 12)  # THE COORINATES##

	iUnitType = CvUtil.findInfoTypeNum(gc.getUnitInfo, gc.getNumUnitInfos(
	), 'UNIT_INFANTRY')  # The Units, here are 3 conquistadors, 1 explorer#
	...
	iUnitType = CvUtil.findInfoTypeNum(
			gc.getUnitInfo, gc.getNumUnitInfos(), 'UNIT_ARTILLERY')
	player.initUnit(iUnitType, plot.getX(), plot.getY(),
					UnitAITypes.NO_UNITAI, DirectionTypes.DIRECTION_SOUTH)
	player.initUnit(iUnitType, plot.getX(), plot.getY(),
					UnitAITypes.NO_UNITAI, DirectionTypes.DIRECTION_SOUTH)
	...
	iUnitType = CvUtil.findInfoTypeNum(
			gc.getUnitInfo, gc.getNumUnitInfos(), 'UNIT_TANK')
	player.initUnit(iUnitType, plot.getX(), plot.getY(),
					UnitAITypes.NO_UNITAI, DirectionTypes.DIRECTION_SOUTH)
	player.initUnit(iUnitType, plot.getX(), plot.getY(),
					UnitAITypes.NO_UNITAI, DirectionTypes.DIRECTION_SOUTH)
	...
	player = gc.getPlayer(kTriggeredData.ePlayer)
	plot = gc.getMap().plot(43, 15)  # THE COORINATES##
	iUnitType = CvUtil.findInfoTypeNum(gc.getUnitInfo, gc.getNumUnitInfos(
	), 'UNIT_INFANTRY')  # The Units, here are 3 conquistadors, 1 explorer#
	player.initUnit(iUnitType, plot.getX(), plot.getY(),
					UnitAITypes.NO_UNITAI, DirectionTypes.DIRECTION_SOUTH)
	...
	player.initUnit(iUnitType, plot.getX(), plot.getY(),
					UnitAITypes.NO_UNITAI, DirectionTypes.DIRECTION_SOUTH)
	iUnitType = CvUtil.findInfoTypeNum(gc.getUnitInfo, gc.getNumUnitInfos(
	), 'UNIT_L335')  # The Units, here are 3 conquistadors, 1 explorer#
	player.initUnit(iUnitType, plot.getX(), plot.getY(),
					UnitAITypes.NO_UNITAI, DirectionTypes.DIRECTION_SOUTH)
	player.initUnit(iUnitType, plot.getX(), plot.getY(),
					UnitAITypes.NO_UNITAI, DirectionTypes.DIRECTION_SOUTH)
	iUnitType = CvUtil.findInfoTypeNum(gc.getUnitInfo, gc.getNumUnitInfos(
	), 'UNIT_DO17')  # The Units, here are 3 conquistadors, 1 explorer#
	player.initUnit(iUnitType, plot.getX(), plot.getY(),
					UnitAITypes.NO_UNITAI, DirectionTypes.DIRECTION_SOUTH)
	player.initUnit(iUnitType, plot.getX(), plot.getY(),
					UnitAITypes.NO_UNITAI, DirectionTypes.DIRECTION_SOUTH)
	...
	player.initUnit(iUnitType, plot.getX(), plot.getY(),
					UnitAITypes.NO_UNITAI, DirectionTypes.DIRECTION_SOUTH)
	iUnitType = CvUtil.findInfoTypeNum(gc.getUnitInfo, gc.getNumUnitInfos(
	), 'UNIT_MESSERSCHMIT_BF109')  # The Units, here are 3 conquistadors, 1 explorer#
	player.initUnit(iUnitType, plot.getX(), plot.getY(),
					UnitAITypes.NO_UNITAI, DirectionTypes.DIRECTION_SOUTH)
	player.initUnit(iUnitType, plot.getX(), plot.getY(),
					UnitAITypes.NO_UNITAI, DirectionTypes.DIRECTION_SOUTH)
	player = gc.getPlayer(kTriggeredData.ePlayer)
	plot = gc.getMap().plot(44, 8)  # THE COORINATES##
	iUnitType = CvUtil.findInfoTypeNum(
			gc.getUnitInfo, gc.getNumUnitInfos(), 'UNIT_ARTILLERY')
	player.initUnit(iUnitType, plot.getX(), plot.getY(),
					UnitAITypes.NO_UNITAI, DirectionTypes.DIRECTION_SOUTH)
...
def VichyFranceTrriger(argsList):  # Remember that that's the tag##
	...
	if (turn == 305):
		...
		if (player.getCivilizationType() == gc.getInfoTypeForString("CIVILIZATION_WW2_VICHY")):  # Defines the Civilization
			return True

	return False
def VichyFrance(argsList):
	'Called at the beginning of the end of each turn'
	iEvent = argsList[0]
	kTriggeredData = argsList[1]
	...
	player = gc.getPlayer(kTriggeredData.ePlayer)
	plot = gc.getMap().plot(49, 16)  # THE COORINATES##
	...
	player = gc.getPlayer(kTriggeredData.ePlayer)
	plot = gc.getMap().plot(50, 18)  # THE COORINATES##
	...
	player = gc.getPlayer(kTriggeredData.ePlayer)
	plot = gc.getMap().plot(52, 5)  # THE COORINATES##
	...
	player.initUnit(iUnitType, plot.getX(), plot.getY(),
					UnitAITypes.NO_UNITAI, DirectionTypes.DIRECTION_SOUTH)
	iUnitType = CvUtil.findInfoTypeNum(gc.getUnitInfo, gc.getNumUnitInfos(
	), 'UNIT_MACHINE_GUN')  # The Units, here are 3 conquistadors, 1 explorer#
	player.initUnit(iUnitType, plot.getX(), plot.getY(),
					UnitAITypes.NO_UNITAI, DirectionTypes.DIRECTION_SOUTH)
	player.initUnit(iUnitType, plot.getX(), plot.getY(),
					UnitAITypes.NO_UNITAI, DirectionTypes.DIRECTION_SOUTH)
	...
	player = gc.getPlayer(kTriggeredData.ePlayer)
	plot = gc.getMap().plot(43, 6)  # THE COORINATES##
	...
	player = gc.getPlayer(kTriggeredData.ePlayer)
	plot = gc.getMap().plot(46, 3)  # THE COORINATES##
	...
	player = gc.getPlayer(kTriggeredData.ePlayer)
	plot = gc.getMap().plot(40, 4)  # THE COORINATES##
	...
	player = gc.getPlayer(kTriggeredData.ePlayer)
	plot = gc.getMap().plot(47, 6)  # THE COORINATES##
	...
	player = gc.getPlayer(kTriggeredData.ePlayer)
	plot = gc.getMap().plot(49, 6)  # THE COORINATES##
	...
	player.initUnit(iUnitType, plot.getX(), plot.getY(),
					UnitAITypes.NO_UNITAI, DirectionTypes.DIRECTION_SOUTH)
def ALIENTrriger(argsList):  # Remember that that's the tag##
	kTriggeredData = argsList[0]
	turn = kTriggeredData.iTurn
	player = gc.getPlayer(kTriggeredData.ePlayer)
	if (turn == 285):
		...
		if (player.getCivilizationType() == gc.getInfoTypeForString("CIVILIZATION_ALIEN")):  # Defines the Civilization
			return True
def ALIEN(argsList):
	'Called at the beginning of the end of each turn'
	iEvent = argsList[0]
	...
	player = gc.getPlayer(kTriggeredData.ePlayer)
	plot = gc.getMap().plot(68, 13)  # THE COORINATES##

	iUnitType = CvUtil.findInfoTypeNum(gc.getUnitInfo, gc.getNumUnitInfos(
	), 'UNIT_ALIEN')  # The Units, here are 3 conquistadors, 1 explorer#
	player.initUnit(iUnitType, plot.getX(), plot.getY(),
					UnitAITypes.NO_UNITAI, DirectionTypes.DIRECTION_SOUTH)
	player.initUnit(iUnitType, plot.getX(), plot.getY(),
					UnitAITypes.NO_UNITAI, DirectionTypes.DIRECTION_SOUTH)
